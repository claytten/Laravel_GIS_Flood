            ...
            <div class="mdl-grid">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                            <input class="mdl-textfield__input @error('password_confirmation') is-invalid @enderror" type="password" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}">
                            <label class="mdl-textfield__label" for="password_confirmation">Re Type Password</label>
